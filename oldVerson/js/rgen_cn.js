...
rgen.slider = function (owlObj) {
  ...
  $(owlObj).animate({
    ...
    $(owlObj).find('.carousel-btn .prev').on('click', function () {
      owlEle.trigger('prev.owl.carousel');
    });
    $(owlObj).find('.carousel-btn .next').on('click', function () {
...
rgen.global_validation = {
  ...
  successMsg: "<div class='msg-success alert alert-success' role='alert'>Thanks for signing up.</div>",
  ...
  jQuery(document).ready(function ($) {
    ...
    if (rgen.elcheck("#subscribe")) {
      ...
      var subscribe_validate_data = {
        ...
        msgpos: 'append',
        successMsg: "<div class='msg-success'>邮箱已经提交，感谢您的来访</div>",
